...
public class AnkleMonitorKey extends Item {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player, @NotNull InteractionHand hand) {
        ...
        if (currentFeet.getOrCreateTag().getBoolean("Locked")) {
            ...
            if (config.getPlayersOwnAnkleMonitorLockBehavior().equals("onlyLock") || config.getPlayersOwnAnkleMonitorLockBehavior().equals("none")) {
            ...
            if (player.getTags().contains("prisoner") && config.getPrisonersOwnAnkleMonitorLockBehavior().equals("onlyLock".toLowerCase()) || (config.getPrisonersOwnAnkleMonitorLockBehavior().equals("none"))) {
                player.playSound(SoundEvents.IRON_DOOR_CLOSE, 1, (float) Math.random() * 1.5F);
            ...
            if (player.getTags().contains("prisoner") && config.getPrisonersOwnAnkleMonitorLockBehavior().equals("onlyUnlock".toLowerCase()) || (config.getPrisonersOwnAnkleMonitorLockBehavior().equals("none"))) {
    ...
    public @NotNull InteractionResult interactLivingEntity(@NotNull ItemStack stack, Player user, @NotNull LivingEntity target, @NotNull InteractionHand hand) {
        ...
        if (targetFeet.getOrCreateTag().getBoolean("Locked")) {
            ...
            if (config.getOtherPlayersAnkleMonitorLockBehavior().equals("onlyLock") || config.getOtherPlayersAnkleMonitorLockBehavior().equals("none")) {
            ...
            if (user.getTags().contains("prisoner") && config.getOtherPrisonersAnkleMonitorLockBehavior().equals("onlyLock".toLowerCase()) || (config.getOtherPrisonersAnkleMonitorLockBehavior().equals("none"))) {
                user.playSound(SoundEvents.IRON_DOOR_CLOSE, 1, (float) Math.random() * 1.5F);
            ...
            if (user.getTags().contains("prisoner") && config.getOtherPrisonersAnkleMonitorLockBehavior().equals("onlyUnlock".toLowerCase()) || (config.getOtherPrisonersAnkleMonitorLockBehavior().equals("none"))) {
                user.playSound(SoundEvents.IRON_DOOR_CLOSE, 1, (float) Math.random() * 1.5F);

...
import git.david.cuffedplus.items.restraints.client.model.HazardTapeHeadModel;
...
;    ICuffedPlusServerConfigMixin config = (ICuffedPlusServerConfigMixin) CuffedMod.SERVER_CONFIG;
    ...
    public HazardTapeHeadRestraint(ItemStack stack, ServerPlayer player, ServerPlayer captor) {
    ...
    public RestraintModelInterface getModelInterface() {
        return new HazardTapeHeadRestraintModelInterface();
    }

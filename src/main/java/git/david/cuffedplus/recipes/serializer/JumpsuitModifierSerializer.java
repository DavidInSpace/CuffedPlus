...
public class JumpsuitModifierSerializer implements RecipeSerializer<JumpsuitModifierRecipe> {

    @Override
    public @NotNull JumpsuitModifierRecipe fromJson(@NotNull ResourceLocation id, @NotNull JsonObject json) {
        ...
        return new JumpsuitModifierRecipe(id, template, base, addition);
    }

    @Override
    public JumpsuitModifierRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
    ...
    @Override
    public void toNetwork(FriendlyByteBuf buf, JumpsuitModifierRecipe recipe) {

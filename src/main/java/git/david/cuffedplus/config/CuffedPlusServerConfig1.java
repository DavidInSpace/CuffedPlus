...
public class CuffedPlusServerConfig1 extends LazrConfig implements ICuffedPlusServerConfig {
    ...
    ConfigProperty<String> OTHER_PRISONERS_ANKLE_MONITOR_BEHAVIOR;
    ...
    public CuffedPlusServerConfig1(String name, ModConfig.Type type) {
        super(name, type);
    }
    ...
    public void registerProperties() {
        CUFFED_PLUS_SETTINGS = createCategory(new ConfigCategory(this, "Cuffed Plus Settings"), (c1) -> {
            ...
            PRISONERS_JUMPSUIT_AND_ANKLE_MONITOR_BEHAVIOR_SETTINGS = createCategory(new ConfigCategory(this, "Prisoners Jumpsuit & Ankle Monitor Behavior"), (c4) -> {
                ...
                OTHER_PRISONERS_ANKLE_MONITOR_BEHAVIOR = c4.putProperty(new ConfigProperty<String>(this, "Other Prisoners Ankle Monitor Behavior", "Controls the interaction for taking and putting ankle monitors on and off other prisoners (Options: \"none\", \"onlyPutOn\", \"onlyTakeOff\", \"both\").", "both"));
    ...
    public String getOtherPrisonersAnkleMonitorBehavior() {return OTHER_PRISONERS_ANKLE_MONITOR_BEHAVIOR.get().toLowerCase();}

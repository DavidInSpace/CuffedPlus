...
import static git.david.cuffedplus.config.Config.MISC_OPTIONS;

public class MiscConfigScreen extends AbstractConfigScreen {

    private static final Component SCREEN_TITLE = Component.literal("Roles Config Screen");

    public MiscConfigScreen() {
        super(SCREEN_TITLE);
    }
    ...
    @Override public void init() {
        ...
        int count = 0;
        for (ConfigOption option : MISC_OPTIONS) {
